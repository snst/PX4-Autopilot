...
java --add-exports java.base/java.lang=ALL-UNNAMED --add-exports java.desktop/sun.awt=ALL-UNNAMED --add-exports java.desktop/sun.java2d=ALL-UNNAMED \
	-XX:GCTimeRatio=20 -Djava.ext.dirs= -jar jmavsim_run.jar -udp 14565 -disponly

# java --module-path /usr/share/openjfx/lib --add-modules javafx.controls,javafx.fxml --add-exports java.base/java.lang=ALL-UNNAMED --add-exports java.desktop/sun.awt=ALL-UNNAMED --add-exports java.desktop/sun.java2d=ALL-UNNAMED \
